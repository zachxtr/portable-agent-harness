...
check_file "${AGENT_NAME}/memory/TODO.md"
check_file "${AGENT_NAME}/memory/SHIPPED_MILESTONES.md"
check_file "${AGENT_NAME}/memory/CODING_PRINCIPLES.md"
check_file "${AGENT_NAME}/memory/ARCHITECTURE_CONCEPTS.md"
check_file "${AGENT_NAME}/memory/wip_example-topic.md"
check_file "${AGENT_NAME}/memory/full-cry-sdlc/Full_CRY_Overview.md"
check_file "${AGENT_NAME}/memory/data-experience-journey/DATA_EXPERIENCE_JOURNEY.md"
